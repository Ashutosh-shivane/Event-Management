...
function s(t3, e2, r2, n2) {
  ...
  return e2 && (o2.className = e2), Object.keys(n2).forEach(function(t4) {
    ...
    } else "html" === t4 ? o2.innerHTML = n2[t4] : "text" === t4 ? o2.innerText = n2[t4] : o2.setAttribute(t4, n2[t4]);
...
var E = { options: e({}, y), classNames: e({}, y.classNames), initialize: function(r2) {
  ...
  this.options = e({}, y, r2), this.classNames = e({}, this.classNames, r2.classNames), this.markers = new t.FeatureGroup(), this.classNames.container += " leaflet-geosearch-" + this.options.style, this.searchElement = new v({ searchLabel: this.options.searchLabel, classNames: { container: this.classNames.container, form: this.classNames.form, input: this.classNames.input }, handleSubmit: function(t3) {
  ...
  } }), t.DomEvent.disableClickPropagation(this.button), this.resetButton = s("button", this.classNames.resetButton, this.searchElement.form, { text: this.options.resetButton, "aria-label": this.options.clearSearchLabel, onClick: function() {
  ...
  if (-1 !== [p, d, f].indexOf(t3.keyCode)) if (t3.preventDefault(), t3.keyCode !== p) {
  ...
  try {
    var e2 = this;
    if (m.indexOf(t3.keyCode) > -1) return Promise.resolve();
    var r2 = t3.target.value, n2 = e2.options.provider, o2 = (function() {
      if (r2.length) return Promise.resolve(n2.search({ query: r2 })).then(function(t4) {
...
var U = (function(t3) {
  function e2() {
    for (var e3, r2 = arguments.length, n3 = new Array(r2), o2 = 0; o2 < r2; o2++) n3[o2] = arguments[o2];
    return (e3 = t3.call.apply(t3, [this].concat(n3)) || this).searchUrl = "https://restapi.amap.com/v3/geocode/geo", e3;
  }
  r(e2, t3);
  var n2 = e2.prototype;
  return n2.endpoint = function(t4) {
    var e3 = t4.query, r2 = "string" == typeof e3 ? { address: e3 } : e3;
    return r2.output = "JSON", this.getUrl(this.searchUrl, r2);
  }, n2.parse = function(t4) {
    var e3;
    return (null != (e3 = t4.data.geocodes) ? e3 : []).map(function(t5) {
      return { x: Number(t5.location.substring(0, t5.location.indexOf(","))), y: Number(t5.location.substring(t5.location.indexOf(",") + 1)), label: t5.formatted_address, bounds: null, raw: t5 };
    });
  }, e2;
})(x);
var k = (function(t3) {
...
var P = (function(t3) {
  ...
  return n2.endpoint = function(t4) {
    ...
    return (Array.isArray(t4.data.results) ? t4.data.results : [t4.data.results]).map(function(t5) {
      var e3 = null;
      return t5.bbox && (e3 = [[parseFloat(t5.bbox.lat1), parseFloat(t5.bbox.lon1)], [parseFloat(t5.bbox.lat2), parseFloat(t5.bbox.lon2)]]), { x: Number(t5.lon), y: Number(t5.lat), label: t5.formatted, bounds: e3, raw: t5 };
    });
  }, e2;
})(x);
var R = (function(t3) {
...
var I;
var N = j(function t2(e2, r2) {
  if (e2 === r2) return true;
  if (e2 && r2 && "object" == typeof e2 && "object" == typeof r2) {
    if (e2.constructor !== r2.constructor) return false;
    var n2, o2, i2;
    if (Array.isArray(e2)) {
      if ((n2 = e2.length) != r2.length) return false;
      for (o2 = n2; 0 != o2--; ) if (!t2(e2[o2], r2[o2])) return false;
      return true;
    }
    if (e2.constructor === RegExp) return e2.source === r2.source && e2.flags === r2.flags;
    if (e2.valueOf !== Object.prototype.valueOf) return e2.valueOf() === r2.valueOf();
    if (e2.toString !== Object.prototype.toString) return e2.toString() === r2.toString();
    if ((n2 = (i2 = Object.keys(e2)).length) !== Object.keys(r2).length) return false;
    for (o2 = n2; 0 != o2--; ) if (!Object.prototype.hasOwnProperty.call(r2, i2[o2])) return false;
    for (o2 = n2; 0 != o2--; ) {
      var s2 = i2[o2];
      if (!t2(e2[s2], r2[s2])) return false;
    }
    return true;
  }
  return e2 != e2 && r2 != r2;
...
var O = class _O {
  constructor({ apiKey: t3, authReferrerPolicy: e2, channel: r2, client: n2, id: o2 = "__googleMapsScriptId", language: i2, libraries: s2 = [], mapIds: a2, nonce: l2, region: c2, retries: u2 = 3, url: h2 = "https://maps.googleapis.com/maps/api/js", version: p2 }) {
    if (this.callbacks = [], this.done = false, this.loading = false, this.errors = [], this.apiKey = t3, this.authReferrerPolicy = e2, this.channel = r2, this.client = n2, this.id = o2 || "__googleMapsScriptId", this.language = i2, this.libraries = s2, this.mapIds = a2, this.nonce = l2, this.region = c2, this.retries = u2, this.url = h2, this.version = p2, _O.instance) {
      if (!N(this.options, _O.instance.options)) throw new Error(`Loader must not be called again with different options. ${JSON.stringify(this.options)} !== ${JSON.stringify(_O.instance.options)}`);
      return _O.instance;
    }
    _O.instance = this;
  }
    ...
    Object.keys(r2).forEach((t4) => !r2[t4] && delete r2[t4]), (null === (e2 = null === (t3 = null === window || void 0 === window ? void 0 : window.google) || void 0 === t3 ? void 0 : t3.maps) || void 0 === e2 ? void 0 : e2.importLibrary) || ((t4) => {
      ...
      const u2 = c2.maps || (c2.maps = {}), h2 = /* @__PURE__ */ new Set(), p2 = new URLSearchParams(), d2 = () => e3 || (e3 = new Promise((s3, c3) => {
        return d3 = this, m2 = function* () {
          var d4;
          for (n3 in yield r3 = l2.createElement("script"), r3.id = this.id, p2.set("libraries", [...h2] + ""), t4) p2.set(n3.replace(/[A-Z]/g, (t5) => "_" + t5[0].toLowerCase()), t4[n3]);
  ...
  loadErrorCallback(t3) {
    ...
    } else this.onerrorEvent = t3, this.callback();
  }
  callback() {
...
var F = (function(t3) {
  function e2(e3) {
    var r2;
    return (r2 = t3.call(this, e3) || this).loader = null, r2.geocoder = null, "undefined" != typeof window && (r2.loader = new O(e3).load().then(function(t4) {
  ...
  return n2.endpoint = function(t4) {
    ...
    try {
      var e3 = function(e4) {
        if (!e4) throw new Error("GoogleMaps GeoCoder is not loaded. Are you trying to run this server side?");
...
var M = (function(t3) {
  function e2() {
    for (var e3, r2 = arguments.length, n3 = new Array(r2), o2 = 0; o2 < r2; o2++) n3[o2] = arguments[o2];
    return (e3 = t3.call.apply(t3, [this].concat(n3)) || this).searchUrl = "https://geocode.search.hereapi.com/v1/geocode", e3;
  }
  r(e2, t3);
  var n2 = e2.prototype;
  return n2.endpoint = function(t4) {
...
var G = (function(t3) {
  ...
  return n2.endpoint = function(t4) {
    ...
    return t4.data.results.map(function(t5) {
      var e3 = null;
      return t5.bounds && (e3 = [[t5.bounds.southwest.lat, t5.bounds.southwest.lng], [t5.bounds.northeast.lat, t5.bounds.northeast.lng]]), { x: t5.geometry.lng, y: t5.geometry.lat, label: t5.formatted, bounds: e3, raw: t5 };
    });
...
export {
  U as AMapProvider,
  k as BingProvider,
  S as CivilDefenseMapProvider,
  L as EsriProvider,
  C as GeoApiFrProvider,
  w as GeoSearchControl,
  P as GeoapifyProvider,
  A as GeocodeEarthProvider,
  F as GoogleProvider,
  M as HereProvider,
  x as JsonProvider,
  q as LegacyGoogleProvider,
  B as LocationIQProvider,
  D as MapBoxProvider,
  G as OpenCageProvider,
  _ as OpenStreetMapProvider,
  R as PeliasProvider,
  w as SearchControl,
  v as SearchElement
};
